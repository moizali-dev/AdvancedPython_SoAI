...
if __name__ == "__main__":
    ...
    pickle_serializer.dump(the_wall, Path("part2/14-Pickle serialization/the_wall.pkl"))

    the_wall2 = pickle_serializer.load(Path("part2/14-Pickle serialization/the_wall.pkl"))
    print(the_wall2)